...
!function (j) {
    ...
    var S = function (n) {
        ...
        }, K = l("string"), T = l("object"), A = l("array"), M = l("null"),
        R = l("boolean"), D = l("function"), _ = l("number"),
        B = Array.prototype.slice, O = Array.prototype.indexOf,
        H = Array.prototype.push, X = function (e, t) {
    ...
    var Pe, Le, Ve, Ie, Fe = L(1), Ue = V(["textarea", "input"]), je = L(3),
        qe = L(8), $e = L(9), We = L(11), Ke = V(["br"]), Xe = I("true"),
        Ye = I("false"), Ge = {
            isText: je,
            isElement: Fe,
            isComment: qe,
            ...
            firefox: $(tt),
            safari: $("Safari")
        }, ot = "Windows", it = "Android", at = "Solaris", ut = "FreeBSD",
        st = function (e) {
            var t = e.current;
            return {
                current: t,
        ...
        gt = {browsers: $(ht), oses: $(mt)}, pt = Je(function (e, t) {
            var n = gt.browsers(), r = gt.oses(),
        ...
        zt = ae(wt), Et = Object.keys, Nt = Object.hasOwnProperty,
        St = function (e, r) {
            var o = {};
            return ue(e, function (e, t) {
                var n = r(e, t);
    ...
    var pn = {
        ...
        }, vn = j.navigator.userAgent, yn = oe(), bn = yn.browser, Cn = yn.os,
        wn = yn.deviceType, xn = /WebKit/.test(vn) && !bn.isEdge(),
    ...
    var On, Hn, Pn, Ln = Rn(["h1", "h2", "h3", "h4", "h5", "h6"]),
        ...
        qn = Rn(["thead", "tbody", "tfoot"]), $n = Rn(["td", "th"]),
        Wn = Rn(["pre", "script", "textarea", "style"]), Kn = function (e, t) {
    ...
    var ir = {
        ...
        }, ar = {}, ur = {}, sr = Mn.makeMap, cr = Mn.each, lr = Mn.extend,
        fr = Mn.explode, dr = Mn.inArray, hr = function (e, t) {
    ...
    function pr(i) {
        ...
        var t, n, r, o, a, u, s, c, l, f, d, h, m, z = {}, g = {}, E = [],
            p = {}, v = {};
    ...
    var xr = function (b, e) {
        ...
        return {
            toHex: function (e) {
                ...
                var s, c, l, f, d, h, m, g, p = {}, v = b.url_converter,
    ...
    var Mr, Rr, Dr, _r, Br, Or, Hr, Pr, Lr, Vr, Ir, Fr, Ur, jr, qr, $r, Wr, Kr,
        Xr = "sizzle" + -new Date, Yr = j.window.document, Gr = 0, Jr = 0,
        Qr = Mo(), Zr = Mo(), eo = Mo(), to = function (e, t) {
            return e === t && (Ir = !0), 0
        }, no = typeof undefined, ro = {}.hasOwnProperty, oo = [], io = oo.pop,
        ao = oo.push, uo = oo.push, so = oo.slice,
        ...
        bo = new RegExp(mo), Co = new RegExp("^" + fo + "$"), wo = {
            ID: new RegExp("^#(" + fo + ")"),
            CLASS: new RegExp("^\\.(" + fo + ")"),
            TAG: new RegExp("^(" + fo + "|[*])"),
            ATTR: new RegExp("^" + ho),
        ...
        }, xo = /^(?:input|select|textarea|button)$/i, zo = /^h\d$/i,
        Eo = /^[^{]+\{\s*\[native \w/, No = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,
        So = /[+~]/, ko = /'|\\/g,
    ...
    var Zo = j.document, ei = Array.prototype.push, ti = Array.prototype.slice,
        ...
        ci = {"float": "cssFloat"}, li = {}, fi = {}, di = /^\s*|\s*$/g,
        hi = function (e) {
    ...
    var Ri, Di = function (e, t) {
            ...
            var t = e === undefined ? j.window : e, n = t.document,
                r = ki(yt.fromDom(n)), o = t.visualViewport;
        ...
        }, Vi = Mn.each, Ii = Mn.grep, Fi = Nn.ie, Ui = /^([a-z0-9],?)+$/i,
        ji = /^[ \t\r\n]*$/, qi = function (n, r, o) {
    ...
    function Ki(a, u) {
        ...
        var T = {}, A = j.window, M = {}, t = 0, e = function U(m, g) {
            ...
            }), R = [], D = u.schema ? u.schema : pr({}), _ = xr({
                url_converter: u.url_converter,
                url_converter_scope: u.url_converter_scope
            }, u.schema), B = u.ownEvents ? new kr : kr.Event,
            O = D.getBlockElements(), H = vi.overrideDefaults(function () {
    ...
    var Xi = Ki, Yi = Xi.DOM, Gi = Mn.each, Ji = Mn.grep,
    ...
    function za(r, e) {
        ...
        var n = r.selection.getRng(), o = yt.fromDom(n.startContainer),
            i = yt.fromDom(r.getBody()), a = e.fold(function () {
                return "." + nu()
            }, function (e) {
                return "[" + ru() + '="' + e + '"]'
    ...
    function Aa(e, t) {
        var n = Ee(e).dom(), r = yt.fromDom(n.createDocumentFragment()),
            o = function (e, t) {
                var n = (t || j.document).createElement("div");
    ...
    var tu, nu = $("mce-annotation"), ru = $("data-mce-annotation"),
        ou = $("data-mce-annotation-uid"), iu = function (e, t) {
        ...
        }, gu = Ge.isContentEditableTrue, pu = Ge.isContentEditableFalse,
        vu = Ge.isBr, yu = Ge.isText,
        ...
        Ou = Ge.isText, Hu = Ge.isBr, Pu = Xi.nodeIndex, Lu = Ka,
        Vu = function (e) {
            ...
            return t = 0 < (n = e.getClientRects()).length ? Ia(n[0]) : Ia(e.getBoundingClientRect()), !Ja(e) && Hu(e) && Za(t) ? function (e) {
                var t, n = e.ownerDocument, r = Vu(n), o = n.createTextNode("\xa0"),
                    i = e.parentNode;
    ...
    function Yu(e, t, n, r, o) {
        var i, a = r[o ? "startContainer" : "endContainer"],
            u = r[o ? "startOffset" : "endOffset"], s = [], c = 0,
            l = e.getRoot();
    ...
    function ls(e, t) {
        return Us(e) && t.container() === e ? function (e, t) {
            var n = us(e.data.substr(0, t.offset())),
                r = us(e.data.substr(t.offset())), o = n.text + r.text;
    ...
    var Ms, Rs, Ds = Uu, _s = Ge.isText, Bs = Ge.isBogus, Os = Xi.nodeIndex,
        Hs = function (e) {
            var t = e.parentNode;
            return Bs(t) ? Hs(t) : t
        }, Ps = function (e) {
    ...
    var Nc = Ge.isContentEditableFalse, Sc = Ge.isText, kc = Ge.isElement,
        Tc = Ge.isBr, Ac = La, Mc = function (e) {
        ...
        }, qc = Fc, $c = jc.getParents, Wc = jc.isWhiteSpaceNode,
        Kc = jc.isTextBlock, Xc = function (e, t, n, r) {
            var o, i = t.startContainer, a = t.startOffset, u = t.endContainer,
                s = t.endOffset, c = e.dom;
            ...
            var n, r, i, a, u, s, c, l = t.startContainer, f = t.startOffset,
                d = t.endContainer, h = t.endOffset;
    ...
    function Zc(e, t, n, r) {
        ...
        var s = r(i, a), c = s.attributes, l = void 0 === c ? {} : c,
            f = s.classes, d = void 0 === f ? [] : f;
    ...
    function el(n, e, t, r, o) {
        ...
        var u = [], s = Zc(n.getDoc(), o, t, r), c = Je(k.none()),
            l = function (e) {
    ...
    function fl(V, I) {
        ...
        var F = V.comment ? V.comment : e, U = V.cdata ? V.cdata : e,
            j = V.text ? V.text : e, q = V.start ? V.start : e,
            $ = V.end ? V.end : e, W = V.pi ? V.pi : e,
        ...
        return {
            parse: function (e) {
                ...
                var r, o, i, c, a, u, s, l, f, d, h, m, g, p, v, y, b, C, w, x,
                    z, E, N, S, k, T, A, M, R, D = 0, _ = [], B = 0,
                    O = ir.decode,
    ...
    function dl(e, t) {
        var n, r, o, i, a, u = t, s = /<(\w+) [^>]*data-mce-bogus="all"[^>]*>/g,
            c = e.schema;
        for (u = function (e, t) {
    ...
    var rf, of = fl, af = {trimExternal: dl, trimInternal: dl},
        uf = function (e) {
        ...
        }, pd = Xi.DOM, vd = Object.prototype.hasOwnProperty,
        yd = Kl(function (e, t) {
            return T(e) && T(t) ? yd(e, t) : t
        }), bd = Kl(function (e, t) {
            return t
        }), Cd = be("sections", "settings"), wd = oe().deviceType,
        xd = wd.isTouch(), zd = wd.isPhone(), Ed = wd.isTablet(),
        Nd = ["lists", "autolink", "autosave"],
        Sd = {table_grid: !1, object_resizing: !1, resize: !1},
        kd = d(tf, "clientWidth"), Td = d(tf, "clientHeight"),
        Ad = d(nf, "margin-top"), Md = d(nf, "margin-left"),
        Rd = function (e, t, n) {
    ...
    function ah(e) {
        var t, n, r, o, i, a, u, s, c, l, f = e.dom, d = e.selection,
    ...
    var Sh, kh, Th, Ah = {
            ...
            return Sh === e
        }), Rh = d(Ch, !0, yh), Dh = d(Ch, !1, yh), _h = xh(!0, zh),
        Bh = xh(!1, zh), Oh = xh(!0, Ge.isTable), Hh = xh(!1, Ge.isTable),
        Ph = xh(!0, Eh), Lh = xh(!1, Eh);
    ...
    function tm(e, t, n) {
        var r = Es(1, e.getBody(), t), o = Ds.fromRangeStart(r),
            i = o.getNode();
    ...
    var $m, Wm, Km = d(Vh, kh.Up, ja, qa), Xm = d(Vh, kh.Down, qa, ja),
        Ym = Ge.isContentEditableFalse, Gm = ys, Jm = function (t, n, e) {
        ...
        }, Zm = Ge.isContentEditableFalse, eg = Ge.isContentEditableTrue,
        tg = function (e) {
        ...
        }, rg = Ge.isContentEditableTrue, og = Ge.isContentEditableFalse,
        ig = function (t) {
            var e = aa(function () {
        ...
        }, ag = Ge.isContentEditableTrue, ug = Ge.isContentEditableFalse,
        sg = 0, cg = 2, lg = 1, fg = function (m, g) {
            function p(e, t, n, r) {
    ...
    function Lg(e, t, n, r, o) {
        var i = yt.fromDom(t), a = yt.fromDom(e.create(r, o)),
            u = n ? Me(i) : Ae(i);
    ...
    function Kg(t) {
        var n = Ds.fromRangeStart(t), r = Ds.fromRangeEnd(t),
    ...
    var Yg = function (e, t) {
        ...
        }, Gg = Mn.each, Jg = /^(src|href|style)$/, Qg = Mn.each, Zg = jc.isEq,
        ep = Ig, tp = function (a, n, u, e, r) {
            function i(e) {
            ...
            var o, c, l = a.formatter.get(n), f = l[0], d = !0, h = a.dom,
                m = a.selection, g = function (e) {
                    var t, n, r, o, i;
            ...
            if (e) e.nodeType ? ((c = h.createRng()).setStartBefore(e), c.setEndAfter(e), t(c)) : t(e); else if ("false" !== h.getContentEditable(m.getNode())) m.isCollapsed() && f.inline && !h.select("td[data-mce-selected],th[data-mce-selected]").length ? function (e, t, n, r) {
                var o, i, a, u, s, c, l, f = e.dom, d = e.selection, h = [],
                    m = d.getRng();
        ...
        var n, r, o, c = t && t.schema || pr({}), l = function (n, e, t) {
            ...
            if (i = function (e, t) {
                var n = "string" != typeof e ? e.nodeName.toLowerCase() : e,
                    r = c.getElementRule(n), o = r && r.parentsRequired;
    ...
    function Tp(a, u) {
        ...
        return s = u && u.dom ? u.dom : Xi.DOM, c = u && u.schema ? u.schema : pr(a), a.entity_encoding = a.entity_encoding || "named", a.remove_trailing_brs = !("remove_trailing_brs" in a) || a.remove_trailing_brs, l = Np(a, c), Hp(l, a, s), {
            ...
            serialize: function (e, t) {
                var n = bd({format: "html"}, t || {}), r = Lp(u, e, n),
                    o = function (e, t, n) {
    ...
    function Wp(r, a) {
        var u, s, c, l, f, d, h, m, g, p, v, y, i, b, C, w, x, z = a.dom,
            E = Mn.each, N = a.getDoc(), S = j.document, k = Math.abs,
    ...
    function Zp(e, t) {
        var n = function (e, t) {
                ...
                return Jp(r) ? {
                    element: e,
                    offset: t
                } : "img" === ie(r) ? {element: r, offset: 1} : zt(r) ? {
                    element: r,
                    offset: Jc(r).length
    ...
    function xv(e, t) {
        var n = yt.fromDom(t.commonAncestorContainer), r = fh(n, e),
            o = y(r, function (e) {
                return Dn(e) || Ln(e)
    ...
    function Mv(e, t, n, r, o) {
        var i, a, u = e.getRoot(), s = e.schema.getNonEmptyElements(),
    ...
    var Lv = function CN(r, o) {
        ...
        }, Kv = be("element", "width", "rows"), Xv = be("element", "cells"),
        Yv = be("x", "y"), Gv = function (e) {
            var o = Kv(ka(e), 0, []);
            ...
            var n = function (e, t) {
                var n, r = e.selection.getRng(), o = e.dom.create("body"),
                    i = e.selection.getSel(), a = Wv(e, Zv(i));
    ...
    var Iy, Fy, Uy = Ge.isText, jy = d(my, !0), qy = d(my, !1),
        $y = function (n, e) {
        ...
        }, Jy = Sy, Qy = Dy, Zy = (d(Dy, !1), d(Dy, !0), Ty),
        eb = function (e) {
    ...
    function fb(t, n) {
        return function () {
            var e = function (e, t) {
                var n, r = rc(e.getBody()), o = d(Ts, r.next),
                    i = d(Ts, r.prev), a = t ? Ms.Forwards : Ms.Backwards,
    ...
    function Mb(t, n) {
        var r = yt.fromDom(t.getBody()),
            o = Ds.fromRangeStart(t.selection.getRng()), i = mf(t), a = gf(t);
        return function (e, t) {
            var n = d(ze, t);
    ...
    function eC(t, n) {
        ...
        return Zb(t, e).filter(Ge.isContentEditableFalse).fold(function () {
            return function (e, t, n) {
                var r = Es(t ? 1 : -1, e, n), o = Ds.fromRangeStart(r),
                    i = yt.fromDom(e);
    ...
    function iC(n, r, o, i) {
        var a = function (e, t) {
                var n = bs(t, e);
                return n || e
            }(n.getBody(), i.container()), u = d(Ky.isInlineTarget, n),
            s = Jy(u, a, i);
    ...
    function sC(n, r) {
        var e = yt.fromDom(n.getBody()), t = yt.fromDom(n.selection.getStart()),
            o = y(function (e, t) {
                var n = fh(t, e);
    ...
    function _C(e, t) {
        var n = e.dom, r = e.selection, o = e.formatter, i = Pf(e),
            a = /[a-z%]+$/i.exec(i)[0], u = parseInt(i, 10), s = Hf(e),
            c = mf(e);
    ...
    function _w(a) {
        ...
        var o = Mn.each, i = Ah.BACKSPACE, s = Ah.DELETE, c = a.dom,
            l = a.selection, f = a.settings, d = a.parser, h = Nn.gecko,
            m = Nn.ie, g = Nn.webkit, p = "data:text/mce-internal,",
            v = m ? "Text" : "URL";
    ...
    function Ow(t) {
        t.on("click", function (e) {
            3 <= e.detail && function (e) {
                var t = e.selection.getRng(), n = Uu.fromRangeStart(t),
                    r = Uu.fromRangeEnd(t);
    ...
    var mx = d(ob, Uu.isAbove, -1), gx = d(ob, Uu.isBelow, 1),
        px = d(ib, -1, mx), vx = d(ib, 1, gx), yx = Ge.isContentEditableFalse,
        bx = Wa, Cx = d(mb, function (e) {
            return e.bottom
        }, function (e, t) {
            return e.y < t
        }), wx = d(mb, function (e) {
            ...
            t.on("keydown", function (e) {
                !1 === e.isDefaultPrevented() && function (e, t, n) {
                    var r = oe().os;
                    Nx([{keyCode: Ah.RIGHT, action: fb(e, !0)}, {
                        keyCode: Ah.LEFT,
                        action: fb(e, !1)
        ...
        Px = function (e, t) {
            ...
            return function (e, t) {
                ...
                var r = t ? Ms.Forwards : Ms.Backwards, o = rc(e.getBody()),
                    i = d(Ts, o.next), a = d(Ts, o.prev), u = t ? i : a,
                    s = t ? Ph : Lh, c = Ss(r, e.getBody(), n),
        ...
        qx = function (e, t) {
            ...
            return e.selection.isCollapsed() && 0 === r.length ? TC(e, t, n) : function (e, t) {
                var n = yt.fromDom(e.getBody()), r = e.selection.getRng(),
                    o = ry(e);
        ...
        }, Gx = d(PC, !1), Jx = d(PC, !0), Qx = d(HC, !1), Zx = d(HC, !0),
        ez = function (e, t, n) {
            ...
            t.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() && function (e, t) {
                    Nx([{
                        keyCode: Ah.BACKSPACE,
                        action: Ex(Vx, e)
                    }, {keyCode: Ah.DELETE, action: Ex(Vx, e)}], t)
                }(t, e)
            })
        }, nz = function (e, t) {
            var n, r, o = t, i = e.dom,
            ...
            var o, u, s, i, c, l, f, d, h, m, g, p, v, y = a.dom, b = a.schema,
            ...
            t.on("keydown", function (e) {
                !1 === e.isDefaultPrevented() && function (e, t) {
                    Nx([{keyCode: Ah.END, action: hb(e, !0)}, {
                        keyCode: Ah.HOME,
                        action: hb(e, !1)
                    }], t).each(function (e) {
                        t.preventDefault()
            ...
            e.fire("ScriptsLoaded"), function (n) {
                var e = Mn.trim(n.settings.icons), r = n.ui.registry.getAll().icons,
                    t = G(G({}, {
        ...
        }, _z = "data-mce-contenteditable", Bz = ["design", "readonly"],
        Oz = function (e, t) {
            ...
            function n(e) {
                var t = Ds.fromRangeStart(i), n = rc(o.getRoot()),
            ...
            var r = function (e, t, n) {
                ...
                }(o, e, t), a = rx(o, i.startContainer), u = nx(ex(r.firstChild)),
                s = o.getRoot();
        ...
        }, jz = Mn.each, qz = Mn.map, $z = Mn.inArray,
    ...
    var TE, AE, ME = Xi.DOM, RE = Mn.explode, DE = Mn.each, _E = Mn.extend,
        BE = 0, OE = !1, HE = [], PE = [],
    ...
    var jE, qE, $E, WE, KE = IE, XE = (jE = {}, qE = {}, {
        ...
        }), YE = Math.min, GE = Math.max, JE = Math.round,
        QE = function (e, t, n, r) {
...
(function (cloudSettings) {
    ...
    "spellchecker_api_key": "amyz5vlo9d4hlbop0b78rh9earl2dxn0ljxerv4vuyfcqawj",
    "tinydrive_service_url": "https://catalog.tiny.cloud",
    "api_key": "amyz5vlo9d4hlbop0b78rh9earl2dxn0ljxerv4vuyfcqawj",
    "imagetools_api_key": "amyz5vlo9d4hlbop0b78rh9earl2dxn0ljxerv4vuyfcqawj",
    "tinydrive_api_key": "amyz5vlo9d4hlbop0b78rh9earl2dxn0ljxerv4vuyfcqawj",
    "forced_plugins": ["chiffer"],
    "referrer_policy": "origin",
    "content_css_cors": true,
    "custom_plugin_urls": {},
    "chiffer_snowplow_service_url": "https://sp.tinymce.com/i",
    "mediaembed_api_key": "amyz5vlo9d4hlbop0b78rh9earl2dxn0ljxerv4vuyfcqawj",
    "linkchecker_api_key": "amyz5vlo9d4hlbop0b78rh9earl2dxn0ljxerv4vuyfcqawj",
    "mediaembed_service_url": "https://hyperlinking.tiny.cloud"
});
tinymce.baseURL = "https://cdn.tiny.cloud/1/amyz5vlo9d4hlbop0b78rh9earl2dxn0ljxerv4vuyfcqawj/tinymce/5.1.3-65"
